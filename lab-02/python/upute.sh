...
echo ""
echo ">>> ./usermgmt.sh add sgros"
echo "### Molim Vas da unesete jednake lozinke duljine vece ili jednake 8 znakova. ###"
./usermgmt.sh add sgros

echo ""
echo ">>> ./login.sh nepostojeci"
echo "### Unos lozinki nije bitan jer korisnik ne postoji. ###"
...
echo ""
echo ">>> ./login.sh sgros"
echo "### Molim Vas da unesete ispravnu lozinku, zatim kod promjene lozinke unesete neispravan par lozinka (razlicite lozinke ili duljina < 8). ###"
./login.sh sgros

echo ""
echo ">>> ./login.sh sgros"
echo "### Molim Vas da unesete ispravnu lozinku, zatim kod promjene lozinke unesete ispravan par lozinka (jednake lozikne i duljina >= 8). ###"
./login.sh sgros
